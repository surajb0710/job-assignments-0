      ...
      <div className="fixed top-0 z-50 px-20">
        <div className="relative bg-gradient my-10 gap-5 px-10 py-5 flex flex-col justify-center rounded-2xl shadow-[inset_0px_0px_7px_1px_#f7fafc90]">
          ...
          <div className="grid grid-cols-2 grid-rows-[1fr_max-content] space-y-2">
            ...
            <div className="h-max">
              ...
              <div className="p-2 border border-[#9793b5] rounded-md bg-[#9793b590] ml-5 w-max">
                <p className="text-sm">Only those candidates can apply who:</p>
                <ol className="list-decimal list-inside">
                  <li className="text-sm">
          ...
          <div>
            ...
            <p className="text-sm">Annual CTC: ₹ 2,00,000 - 3,00,000 /year</p>
          </div>
          <div>
            ...
            <p className="text-sm text-wrap">
              ...
              software products. LaraPush is our flagship product, offering a
              robust push notification technology designed to drive user
              engagement and conversions for website owners. With LaraPush,
              staying connected with your audience has never been easier or more
              effective.
            </p>
          </div>
          <button
