...
function AnimatedForm({ children }) {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="h-100 blur-sm translate-x-[55%] scale-120 overflow-clip relative col-start-2 col-end-3 row-start-1 row-end-2 rounded-2xl backdrop-blur-sm shadow-[inset_0px_2px_20px_-3px_rgba(_255,_255,_255,1)]"
    >
      <motion.div
        custom={0}
        animate={controls}
