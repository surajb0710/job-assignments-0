  ...
  return (
    <div className="bg-black rounded-2xl p-6 flex flex-col gap-3 border border-white">
      ...
      <div className="flex gap-4">
        ...
        <p className="text-white text-[12px] flex gap-2 items-center">
          <img src={globe} alt="" className="h-3 w-3" />
          WorldWide
        </p>
      </div>
      <button
...
const Card = ({ title, description, buttonLabel }) => {
  return (
    <div className="h-full flex flex-col justify-between gap-4 p-6 rounded-2xl border-2 border-white">
